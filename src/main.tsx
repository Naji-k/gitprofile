    ...
    <ThemeProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/projects/slack-bot" element={<DetailPage title="Slack Bot Project" markdownPath="/content/slack-bot.md" />} />
          <Route path="/projects/ai-projects" element={<DetailPage title="" markdownPath="/content/ai-projects.md" />} />
